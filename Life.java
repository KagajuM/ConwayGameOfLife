...
public class Life {
	...
	private UI buildUI(RootPaneContainer pane) {
		return new UI(n, numThreads, pane, pauseIterations, headless, glider);
	}
...
class Worker implements Callable {
	...
	// Constructor
	//
	public Worker(LifeBoard LB, Coordinator C, UI U, int start, int end) {
		lb = LB;
		c = C;
		u = U;
		this.start = start;
...
class UI extends JPanel {
	...
	// Constructor
	//
	public UI(int N, long numThreads2, RootPaneContainer pane, int pauseIterations,
